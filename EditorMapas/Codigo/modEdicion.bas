...
'*************************************************
    ...
    If tY < 1 Or tY > MaxYBorder Then Exit Sub
    If tX < 1 Or tX > MaxXBorder Then Exit Sub
    ...
    If Button = vbLeftButton Then
        ...
        If frmMain.cInsertarTrans.value = True Then
            ...
            If Val(frmMain.tTMapa.Text) < 0 Or Val(frmMain.tTMapa.Text) > 9000 Then
                ...
                Exit Sub
            ElseIf Val(frmMain.tTX.Text) < 0 Or Val(frmMain.tTX.Text) > MaxXBorder Then
                MsgBox "Valor de X invalido", vbCritical + vbOKOnly
                Exit Sub
            ElseIf Val(frmMain.tTY.Text) < 0 Or Val(frmMain.tTY.Text) > MaxYBorder Then
