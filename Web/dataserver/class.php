...
/*	for ($i = 1; $i <= 6; ++$i) {
	...
	function mzdecode($str,$code = 'mzbbfdtt'){	
		...
		$temp=str_replace('*7','=',$temp);
		$temp=str_replace('BB#','H',$temp);
		$temp=str_replace('/*/','=',$temp);
		$temp=str_replace('xD','5',$temp);
		$temp=str_replace('XO','Y',$temp);
		$temp=str_replace('#7#','F',$temp);
		$temp=str_replace('WA!','X',$temp);
		$temp=str_replace(':D!','R',$temp);
