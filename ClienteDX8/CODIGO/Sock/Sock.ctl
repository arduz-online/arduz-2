...
Begin VB.UserControl Sock 
   ...
   Picture         =   "Sock.ctx":0000
   ScaleHeight     =   32
   ScaleMode       =   3  'Pixel
   ScaleWidth      =   32
   ToolboxBitmap   =   "Sock.ctx":0C42
End
...
Private Const BufferSize As Long = 16384
...
Private PacketInPos As Byte
Private PacketOutPos As Byte
