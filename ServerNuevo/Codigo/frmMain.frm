...
Begin VB.Form frmMain3 
   ...
   Begin VB.CommandButton Command1c 
      Caption         =   "not visible"
      Height          =   315
      Left            =   6360
      TabIndex        =   66
   ...
   Begin VB.Frame Frame1 
      ...
      End
   End
   Begin VB.CheckBox NAC 
      Caption         =   "Noicoder Anti-Cheat (Puede dar ""lag"")"
      Height          =   255
      Left            =   120
      TabIndex        =   47
      Top             =   120
   ...
   Begin VB.Frame Frame3 
      ...
      Begin VB.ComboBox maxu 
         Height          =   315
         ItemData        =   "frmMain.frx":0DA2
         Left            =   960
         List            =   "frmMain.frx":0DA4
      ...
      Begin VB.ComboBox ronda 
         ...
         EndProperty
         Height          =   315
         ItemData        =   "frmMain.frx":0DA6
         Left            =   1680
         List            =   "frmMain.frx":0DA8
         Style           =   2  'Dropdown List
         TabIndex        =   23
         Top             =   240
         Width           =   2775
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.ComboBox clasebot 
         ...
         EndProperty
         Height          =   315
         ItemData        =   "frmMain.frx":0DAA
         Left            =   600
         List            =   "frmMain.frx":0DC6
         TabIndex        =   69
         Text            =   "Bot Clase..."
         Top             =   1200
         Width           =   1455
      ...
      Begin VB.ComboBox mankoo 
         ...
         EndProperty
         Height          =   315
         ItemData        =   "frmMain.frx":0E0D
         Left            =   600
         List            =   "frmMain.frx":0E0F
         Style           =   2  'Dropdown List
         TabIndex        =   18
         Top             =   840
         Width           =   1455
...
'            If Npclist(BotList(i)).flags.NPCActive = True Then Call QuitarNPC(BotList(i))
'        Next i
'End If
'End Sub
'
